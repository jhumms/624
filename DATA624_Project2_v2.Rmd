...
Using the RMSE, we see the best performing model of those created is the SVM model. Next we will proceed to evaluate the model and its important variables using `varImp`.
...
```{r message=FALSE, warning=FALSE}
predict <- round(predict(svmModel, newdata=test_features),2)
